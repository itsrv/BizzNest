...
public class InvoicePaneController implements Initializable {
    ...
    public DatePicker Dateofdeparture;
    ...
    public TextField Invoice_billno;
  ...
  public  View_Sql view_sql;
   public newInvoiceSql Invoice_Sql;
    ...
    //genrate Billno
    public void Set_GenrateBill_no() throws SQLException{
        if(Invoice_Sql.getInvoice_Billno()== null){
                Invoice_billno.setText("1");
        }
                else{
                Invoice_billno.setText(""+(Invoice_Sql.getInvoice_Billno()+1));
        }
    }
    ...
    //Bill no. search in database
    public Boolean BillnoSearch() throws SQLException{
        ObservableList list =FXCollections.observableArrayList();
        list.add(Invoice_Sql.getInvoice_Billno());
    ...
    public void Priview_Bill() throws SQLException
    {
        ...
        else
        {
                ...
                boolean Billcheck = BillnoSearch();
                if(Billcheck == true)
                {
                    Prompt_pane.setVisible(true);
                    Prompt_pane.toFront();
                    Prompt_lable.setText("Bill no. already exist please try anothor bill no.");
                }
                else
                {
                    Invoice_Sql.Temp_Invoice_ClintDetailes_clear();
                    Invoice_Sql.Temp_Invoice_Product_detailes_clear();
                    Invoice_Sql.Temp_Invoice_Amount_detailes_clear();
                    //Saving bill no in Bill table
                    //Invoice_Sql.SetInvoice_Billno(Integer.parseInt(Invoice_billno.getText()));
                    //
                    ...
                    {
                            Invoice_Sql.Temp_Upload_InvoiceClint_detailes(
                    ...
                    //
                        System.out.print(""+Invoice_Table_List.size());
                    //saving product data in db
                    for(int i=0;i<Invoice_Table_List.size();i++)
                    {
                              Invoice_Sql.Temp_Upload_Invoice_product_detailes(
                                    Integer.parseInt(Invoice_billno.getText()), 
                   ...
                   {
                           Invoice_Sql.Temp_Upload_Invoice_Amount_Detailes(
                           Integer.parseInt(Invoice_billno.getText()),
                           "0",
            ...
            //    Prompt_pane.setVisible(true);
              //  Prompt_pane.toFront();
                ...
                //Invoice_Sql.Temp_Invoice_Product_detailes(Integer.parseInt(Invoice_billno.getText()));
    ...
    public void SaveBill() throws SQLException{
        ...
        else
        {
                ...
                else
                {
                    ...
                    {
                            Invoice_Sql.Upload_InvoiceClint_detailes(
                            Integer.parseInt(Invoice_billno.getText()),
                            Invoicetype.getSelectionModel().getSelectedItem().toString(),
                            Clint.getSelectionModel().getSelectedItem().toString(),
                            "",
                    ...
                    for(int i=0;i<Invoice_Table_List.size();i++)
                    {
                              Invoice_Sql.Upload_Invoice_product_detailes(
                              Integer.parseInt(Invoice_billno.getText()), 
                              ino.getCellData(i).toString(),
                              itproduct.getCellData(i),
                              itdesc.getCellData(i),
                   ...
                   if(Invoice_discount_combo.getSelectionModel().isEmpty()
                      ...
                      || Dateofdeparture.getValue() == null)
                   {
                           Invoice_Sql.Upload_Invoice_Amount_Detailes(
                           Integer.parseInt(Invoice_billno.getText()),
                           "0",
                           paymenttype.getSelectionModel().getSelectedItem().toString(),
                           amountpaid.getText(),
